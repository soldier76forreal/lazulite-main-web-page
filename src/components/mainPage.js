        ...
        <Fragment>
            ...
            <MainNav></MainNav>
                ...
                <div className={Style.briefCardDiv}>
                    <Row >
                        <Col className={Style.briefCardFirstCol}  xs={12} sm={12} md={6} lg={12} xl={6}>
                            <FeaturesBriefCard id='620ad4f3590f8461838825cc' bg={Travertine} name={`تراورتن`}
                        ...
                        <Col className={Style.briefCardSecondCol}  xs={12} sm={12} md={6} lg={12} xl={6}>
                            <FeaturesBriefCard id='620b80425779ab2413f5036b' bg={Granite} name={`گرانیت`} 
                    ...
                    <Row >
                        <Col className={Style.briefCardThirdCol}   xs={12} sm={12}md={6} lg={12} xl={6}>
                            <FeaturesBriefCard id='6246e1e3f4b6e378c538a289' bg={Onix} name={`اونیکس`} 
                        ...
                        <Col className={Style.briefCardFourthCol}   xs={12} sm={12} md={6} lg={12} xl={6}>
                             <FeaturesBriefCard id='621a40a25779ab2413f50377' bg={Marmar} name={`مرمر`} 
                ...
                <div className={Style.cardSliderDiv}>
                    {postForAll.length !== 0?
                         <CardSlider listType='last' cardName="جدید ترین محصولات" data={postForAll}></CardSlider>
                    :null
                }
                </div>

                <div className={Style.aboutUsTilesDiv}>
                    <h5>با لازولیت ماربل آشنایی داری؟</h5>
                    <Row>
                ...
                <div className={Style.opratorsSecDiv}>
                    <h5>همین حالا با ما تماس بگیر</h5>
                    <Row>

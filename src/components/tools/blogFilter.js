...
const BlogFilter = (props) =>{
    ...
    const fm = () =>{
        navigation(`/${location.pathname.split('/')[1]}/blog?${queryParams.get('page') !== null ?`page=${queryParams.get('page')}`:''}&filter=view`)
    }
    return(
        <Fragment>
